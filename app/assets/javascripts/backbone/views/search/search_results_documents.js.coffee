class Quota.Views.SearchResultsDocuments extends Backbone.View
	...
	initialize: (options)->
		...
		@documents_by_name_view = new Quota.Views.SearchResultsDocumentsSubList({collection: @documents_by_name, title: "w/ matching Name", vent: @vent})
		@documents_by_opportunity_name_view = new Quota.Views.SearchResultsDocumentsSubList({collection: @documents_by_opportunity_name, title: "w/ matching Opportunity", vent: @vent})
		@documents_by_opportunity_company_name_view = new Quota.Views.SearchResultsDocumentsSubList({collection: @documents_by_opportunity_company_name, title: "w/ matching Company", vent: @vent})
		@documents_by_po_view = new Quota.Views.SearchResultsDocumentsSubList({collection: @documents_by_po, title: "w/ matching PO", vent: @vent})
		@documents_by_part_number_view = new Quota.Views.SearchResultsDocumentsSubList({collection: @documents_by_part_number, title: "w/ matching Part Number", vent: @vent})
		@documents_by_part_name_view = new Quota.Views.SearchResultsDocumentsSubList({collection: @documents_by_part_name, title: "w/ matching Part Name", vent: @vent})
