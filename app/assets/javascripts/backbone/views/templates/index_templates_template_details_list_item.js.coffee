class Quota.Views.IndexTemplatesTemplateDetailsListItem extends Backbone.View

	template: HandlebarsTemplates['template/index_templates_template_details_list_item'] #Handlebars.compile($("#quote-document").html()) #JST['quotes/index']
