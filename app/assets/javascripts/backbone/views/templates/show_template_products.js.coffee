class Quota.Views.ShowTemplateProducts extends Backbone.View
	...
	initialize: (options)->
		...
		@_addItemView = new Quota.Views.ShowTemplateFormAddProduct({model: new Quota.Models.CatalogItem(), parent_model:@template_model, parent_child_key: @template_model.get("pub_key"), vent: @vent, parent_collection: @collection})
