class Quota.Views.ShowTemplateItems2 extends Backbone.View
	...
	initialize: (options)->
		...
		@_addItemView = new Quota.Views.ShowTemplateFormAddItem2({model: new Quota.Models.TemplateItem(), parent_model:@template_model, parent_child_key: @template_model.get("pub_key"), vent: @vent, parent_collection: @collection, catalog_items: @catalog_items})
		
		@_templateItemsListView = new Quota.Views.ShowTemplateItemsList2({model: new Quota.Models.TemplateItem(), parent_model:@template_model, parent_child_key: @parent_child_key, vent: @vent, collection: @collection, catalog_items: @catalog_items})
