class Quota.Views.ChooseTemplateListTemplates extends Backbone.View
	...
	addOne: (item)->
		view = new Quota.Views.ChooseTemplateListTemplate({model: item, tagName:'li', className:'template', template: @model, vent: @vent})
