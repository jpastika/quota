class Quota.Views.ChooseTemplateListTemplate extends Backbone.View

	template: HandlebarsTemplates['documents/choose_template_list_template'] #Handlebars.compile($("#quote-template").html()) #JST['quotes/index']
