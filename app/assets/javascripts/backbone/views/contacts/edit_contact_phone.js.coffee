class Quota.Views.EditContactPhone extends Backbone.View

	template: HandlebarsTemplates['contacts/edit_contact_phone'] #Handlebars.compile($("#quote-template").html()) #JST['quotes/index']
