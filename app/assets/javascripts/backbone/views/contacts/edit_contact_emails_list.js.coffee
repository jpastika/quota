class Quota.Views.EditContactEmailsList extends Backbone.View
	...
	addOne: (item)->
		...
		view = new Quota.Views.EditContactEmail({model: item, tagName:'li', contact: @model, vent: @vent, index: (@collection.models.length - 1)})
