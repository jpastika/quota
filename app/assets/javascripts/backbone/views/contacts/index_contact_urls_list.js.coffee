class Quota.Views.IndexContactUrlsList extends Backbone.View
	...
	el: '.contact_urls .contact_urls_list'
	...
	initialize: (options)->
		...
		@vent.on('contact_urls:save_new_contact_url_successful', @addNewUrl_Success, @)
	...
	addOne: (item)->
		...
		view = new Quota.Views.IndexContactUrl({model: item, tagName:'li', contact: @model, vent: @vent, index: (@collection.models.length - 1)})
		@_urlViews.push(view)
		view
