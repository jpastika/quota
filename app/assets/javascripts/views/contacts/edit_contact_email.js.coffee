class Quota.Views.EditContactEmail extends Backbone.View

	template: HandlebarsTemplates['contacts/edit_contact_email'] #Handlebars.compile($("#quote-template").html()) #JST['quotes/index']
	...
	render: ->
		$(@el).html(@template({contact_email:@model.toJSON()}))
		if @hideRemove
