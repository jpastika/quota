...
jQuery.tableDnD = {
	...
	/** Cancel table row drag ability */
    cancel: function() {
        // Set up the defaults if any

        this.each(function() {
            // Now make the rows not draggable
            jQuery.tableDnD.makeNotDraggable(this);
        });
		// Don't break the chain
        return this;
    },
    ...
    makeDraggable: function(table) {
        ...
        if (config.dragHandle) {
            ...
            cells.each(function() {
                ...
                jQuery(this).on(startEvent, function(ev) {
	...
	/** This function makes all the rows on the table not draggable */
    makeNotDraggable: function(table) {
        ...
        if (config.dragHandle) {
            ...
            rows.each(function() {
                ...
                var row = jQuery(this);
                if (! row.hasClass("nodrag")) {
                    row.off(startEvent).css("cursor", "pointer"); // Store the tableDnD object
                }
            });
        }
    },
...
jQuery.fn.extend(
    {
		...
		tableDnDCancel : jQuery.tableDnD.cancel,
