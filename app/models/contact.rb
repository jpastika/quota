class Contact < ActiveRecord::Base
  attr_accessible :company_key, :contact_type, :is_disabled, :name, :pub_key, :title
  ...
  has_many :people, :class_name => "Contact", :primary_key => "pub_key", :foreign_key => "company_key", :conditions => Proc.new { "contact_type = 'PERSON'" }
