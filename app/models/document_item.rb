class DocumentItem < ActiveRecord::Base
  attr_accessible :buyout, :catalog_item_key, :day_rate, :description, :discount, :document_item_type, :document_key, :is_disabled, :is_discountable, :is_hidden, :is_taxable, :month_rate, :name, :notes, :parent_item_key, :part_number, :quantity, :serial_number, :sort_order, :total, :unit_price, :week_rate, :pub_key, :year_rate, :unit_price_unit, :term_length, :term_unit
